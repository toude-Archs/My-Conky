...
Hi !
Today I show my conky

![image](https://github.com/toude-Archs/My-Conky/blob/main/Capture%201~.png?raw=true)

My conky is based on the theme of Adrien D's 2017 edition!

Attention at the moment it is a little in French But who will soon have a Patch to switch to Full English!

My Conky is based on that of WarL but that I modified

My conky is Version 2023 1.0!
...
${color3}Windows Server IP: ${color2}Your IP
 ```
